...
import 'package:flutter_agenda_app/database/Helper.dart';
import 'package:flutter_agenda_app/model/User.dart';
import 'package:flutter_agenda_app/utils/Utils.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildFab() {
    ...
    if (_scrollController.hasClients) {
      ...
      if ((min == currentScroll) && (_scrollController.position.userScrollDirection == ScrollDirection.idle)) {
        visibilityFlag = true;
